 ...
 application_id: app_id,
  ...
  policy_targets:
   [ { resource_id: res_id,
       ...
       auth_ip : false,
       auth_time : false,
       alloted_days : [ "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
       auth_ip_start : "192.168.1.10",
       auth_ip_end : "192.168.1.100",
    ...
    application_id: app_id,
     ...
     policy_targets:
      [ { resource_id: res_id,
          resource_name: 'B.Sc. IT' } ] ,
          alloted_days : [ "Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
          auth_ip_start : "192.168.1.101",
          auth_ip_end : "192.168.1.200",
          auth_time_start : "2:00",
          auth_time_end : "18:00",    
          policy_scope:"Protected", 
   }
    var PolicyInvalid={
